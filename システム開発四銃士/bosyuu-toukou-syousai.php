...
<head>
  ...
  <link rel="stylesheet" href="css/style-bosyuu-touroku.css"> <!-- デザインに合うCSSを指定 -->
</head>
<body>
<div id="container">
  <header>
  ...
  <div id="content">
    <div class="image-banner">
      <img src="images/baseball-banner.jpg" alt="野球バナー"> <!-- サンプル画像 -->
    </div>
    
    <section class="post-details">
      <h2><?php echo htmlspecialchars($post['title'], ENT_QUOTES, 'UTF-8'); ?></h2>
      <p class="category"><img src="images/baseball-icon.png" alt="カテゴリアイコン"> 野球</p>
      <hr>
